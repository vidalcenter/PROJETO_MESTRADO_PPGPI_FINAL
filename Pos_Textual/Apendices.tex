...
\center
\FloatBarrier
\caption{\textbf{Exemplos de "Minimum Viable Product" (MVP) desenvolvidos durante o programa}}
\subfigure[ref1][MVP desenvolvido por Tecnococo]{\includegraphics[scale=0.05]{Imagens/prototipo_1.jpg}}
\qquad
\subfigure[ref4][MVP desenvolvido po La Flora Pet]{\includegraphics[scale=0.05]{Imagens/prototipo_4.jpg}}
\qquad
\subfigure[ref2][MVP desenvolvido  MAMP]{\includegraphics[scale=0.14]{Imagens/prototipo_2.jpg}}
\qquad
\subfigure[ref3][MVP desenvolvido por Horta House ]{\includegraphics[scale=0.14]{Imagens/prototipo_3.jpg}}
\qquad
\subfigure[ref2][MVP desenvolvido por Itecagro]{\includegraphics[scale=0.085]{Imagens/prototipo_5.jpg}}
\qquad
\subfigure[ref3][MVP desenvolvido por Ranagro ]{\includegraphics[scale=0.05]{Imagens/prototipo_6.jpg}}
