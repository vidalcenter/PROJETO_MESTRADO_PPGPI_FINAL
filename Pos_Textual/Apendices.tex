...
\subfigure[ref1][Participantes do programa: Palestra 1º dia ]{\includegraphics[scale=0.2]{Imagens/primeiro_dia_1.jpg}}
\qquad
\subfigure[ref2][Participantes do programa: Palestra2º dia]{\includegraphics[scale=0.2]{Imagens/primeiro_dia_2.jpg}}
\qquad
\subfigure[ref3][Participantes do programa: 2º dia]{\includegraphics[scale=0.2]{Imagens/primeiro_dia_3.jpg}}
\qquad
\subfigure[ref4][Participantes do programa: 2º dia]{\includegraphics[scale=0.2]{Imagens/primeiro_dia_4.jpg}}
\fonte{Próprio Autor}.
\label{figura_29}
\end{figure}
