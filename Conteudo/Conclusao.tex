...
Considerando que os escores da perguntas relacionadas a dimensão empreendedora variam de
...
\subfigure[ref1][Autoeficácia antes do programa]{\includegraphics[scale=0.2]{Imagens/histograma_autoeficacia_antes.png}}
\qquad
\subfigure[ref2][Autoeficácia antes do programa]{\includegraphics[scale=0.2]{Imagens/histograma_autoeficacia_apos.png}}
\fonte{Próprio Autor}.
\label{figura_29}
\end{figure}
\newpage
