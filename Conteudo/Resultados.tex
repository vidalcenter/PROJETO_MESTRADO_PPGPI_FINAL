...
\subfigure[ref1][Divulgação]{\includegraphics[scale=0.2]{Imagens/hackaton_1.jpg}}
\qquad
\subfigure[ref2][Cronograma]{\includegraphics[scale=0.2]{Imagens/hackaton_2.jpg}}
\qquad
\fonte{O Autor}.
...
\section{Inovações desenvolvidas: Propostas e Marcas}
\label{inovacoes}
