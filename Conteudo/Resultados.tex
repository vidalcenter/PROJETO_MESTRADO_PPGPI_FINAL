...
\subfigure[ref1][Participantes do programa: 1º dia ]{\includegraphics[scale=0.33]{Imagens/segundo_dia_1.jpg}}
\qquad
\subfigure[ref2][Participantes do programa: 2º dia]{\includegraphics[scale=0.05]{Imagens/segundo_dia_2.jpg}}
\qquad
\subfigure[ref3][Participantes do programa: 2º dia]{\includegraphics[scale=0.05]{Imagens/segundo_dia_3.jpg}}
\fonte{Próprio Autor}.
\label{figura_29}
\end{figure}


\subsection{Makeathon}
...
\center
\FloatBarrier
\caption{\textbf{3º Workshop Empreenda Agro Sustentável}}
\subfigure[ref1][Participantes do programa: Makeathon ]{\includegraphics[scale=0.28]{Imagens/terceiro_dia_1.jpg}}
\qquad
\subfigure[ref2][Participantes do programa: Makeathon dia]{\includegraphics[scale=0.13]{Imagens/terceiro_dia_3.jpg}}
\qquad
\subfigure[ref3][Participantes do programa: Makeathon]{\includegraphics[scale=0.13]{Imagens/terceiro_dia_4.jpg}}
\qquad
\subfigure[ref2][Protótipos desenvolvidos]{\includegraphics[scale=0.13]{Imagens/prototipo_1.jpg}}
\qquad
\subfigure[ref3][Protótipos desenvolvidos]{\includegraphics[scale=0.13]{Imagens/prototipo_2.jpg}}
\qquad
\subfigure[ref3][Protótipos desenvolvidos]{\includegraphics[scale=0.13]{Imagens/prototipo_3.jpg}}
\qquad
\subfigure[ref3][Protótipos desenvolvidos]{\includegraphics[scale=0.13]{Imagens/prototipo_4.jpg}}
\fonte{Próprio Autor}.
\label{figura_30}
\end{figure}
...
Foi realizada Análise Fatorial, para destacar a consistência interna dos resultados obtidos durante o primeiro questionário, objetivando a exclusão de dados com consistência inferior aos demais resultados apresentados \citeonline{damasio_uso_2012}. O teste
...
Gerar novas ideias (antes) - Gerar novas ideias (após) &
  ...
  76,07 &
  0,110 \\
Desenvolver novos produtos (antes) - Desenvolver novos produtos (após) & %Falta fazer
  5 &
  6 &
  61,13 &
  76,06 &
